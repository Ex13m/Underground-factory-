...
export default {
  ru: {
    ...
    'bot.nav.cart': 'Корзина открыта. Если там пусто — это лечится: хиты сами себя не купят. Могу шепнуть код, чтобы чек не кусался.',
    'bot.nav.tv': 'Включаю Видеосалон: записи с камер завода, нон-стоп. Смотри, как наши обвесы живут на воле.',
    'bot.nav.garage': 'Кабинет открыт, гараж там. Кинь свою тачку в гараж — подберу обвес прямо под неё, без примерок.',
    'bot.nav.account': 'Кабинет открыт: гараж, заказы, избранное. Всё как в цеху — по полочкам.',
    'bot.nav.admin': 'Служебная дверь открыта. Пускают только своих — код знаешь, значит свой.',
    'bot.nav.home': 'Возвращаю на главную. Осмотрись — и дай знать, что грузим в корзину.',
  ...
  en: {
    ...
    'bot.nav.cart': 'Cart is open. If it is empty — that is curable: the hits will not buy themselves. I can whisper a code so the total does not bite.',
    'bot.nav.tv': 'Rolling the CCTV lounge: factory camera feeds, nonstop. Watch our kits live in the wild.',
    'bot.nav.garage': 'Account is open, the garage lives there. Drop your ride in — I will fit a kit to it, no guesswork.',
    'bot.nav.account': 'Account is open: garage, orders, favorites. Shop-floor order, everything on its shelf.',
    'bot.nav.admin': 'Service door is open. Staff only — you know the code, so you are staff.',
    'bot.nav.home': 'Taking you home. Look around — and tell me what we are loading into the cart.',
