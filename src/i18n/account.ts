...
export default {
  ru: {
    ...
    'account.invite.text': 'Без идентификации в гараж не пускаем. Там картон, а картон любит своих.',
    ...
    'account.garage.empty.text': 'Даже у Дяди Картона есть «Жигули». Добавь тачку — каталог подстроится под неё.',
    ...
    'account.orders.empty.text': 'Цех простаивает, ножи скучают. Исправь это.',
    ...
    'account.fav.empty.text': 'Сердечки бесплатные, в отличие от фанеры. Жми смелее.',
  ...
  en: {
    ...
    'account.invite.text': 'No ID — no garage. There is cardboard in there, and cardboard trusts its own.',
    ...
    'account.garage.empty.text': 'Even Uncle Cardboard owns a Lada. Add a car — the catalog will adapt to it.',
    ...
    'account.orders.empty.text': 'The shop floor is idle, the blades are bored. Fix that.',
    ...
    'account.fav.empty.text': 'Hearts are free, unlike plywood. Click bravely.',
