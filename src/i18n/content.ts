...
export default {
  ru: {
    ...
    'content.car.identErr': 'Не опознал — проверь ключ Replicate или впиши руками',
    'content.car.identNoKey': 'Нужен ключ Replicate: Админка → АРТ → поле r8_',
  ...
  en: {
    ...
    'content.car.identErr': 'Could not identify — check the Replicate key or type it in',
    'content.car.identNoKey': 'Needs a Replicate key: Admin → ART → r8_ field',
