...
export default {
  ru: {
    ...
    'content.car.ident': '⚡ ОПОЗНАТЬ ПО ФОТО',
    'content.car.identBusy': 'ОПОЗНАЁМ…',
    'content.car.identErr': 'Не опознал — проверь ключ Gemini или впиши руками',
    'content.car.identNoKey': 'Нужен ключ Gemini: включи арт-редактор → NANO BANANA 2 → поле ключа',
  ...
  en: {
    ...
    'content.car.ident': '⚡ IDENTIFY FROM PHOTO',
    'content.car.identBusy': 'IDENTIFYING…',
    'content.car.identErr': 'Could not identify — check the Gemini key or type it in',
    'content.car.identNoKey': 'Needs a Gemini key: enable the art editor → NANO BANANA 2 → key field',
