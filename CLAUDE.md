...
~6 длинных сцен по ~4-4.5 с (заказ владельца 2026-07-10: частая нарезка по 2 с —
брак, «делай как первый и второй рилс»); сцены без повторов локаций —
каждый источник в монтаж один раз; каждый сегмент нормализовать
